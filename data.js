...
export const EXERCISES = {
  ...
  pullup:       { name: "Pull-ups (sub lat pulldown if needed)", muscle: "lats" },
  barbell_row:  { name: "Standing barbell row",      muscle: "mid back" },
  ...
  leg_curl:     { name: "Hamstring curl",            muscle: "hamstrings" },
  walking_lunge:{ name: "Walking lunges (DB)",        muscle: "quads/glutes" },
  calf_raise:   { name: "Standing calf raise",        muscle: "calves" },
  pec_dec:      { name: "Pec deck flyes",            muscle: "chest" },
  seated_row:   { name: "Seated cable row",          muscle: "mid back" },
  leg_ext:      { name: "Leg extension",             muscle: "quads" },
  seated_calf:  { name: "Seated calf raise",         muscle: "calves" },
...
export const WORKOUTS = {
  push: {
    ...
    exercises: [
      ...
      { id: "inc_db_press", sets: 3, reps: "8-10",  rir: 2 },
      { id: "pec_dec",      sets: 3, reps: "10-12", rir: 1 },
  ...
  pull: {
    ...
    exercises: [
      { id: "pullup",       sets: 4, reps: "6-10",  rir: 2, note: "Lat pulldown if pull-ups aren't doable today." },
      { id: "barbell_row",  sets: 3, reps: "8-10",  rir: 1 },
      { id: "seated_row",   sets: 3, reps: "10-12", rir: 1 },
  ...
  legs: {
    ...
    exercises: [
      { id: "leg_press",    sets: 4, reps: "8-10",  rir: 2, note: "Pre-workout carb meal essential." },
      { id: "leg_ext",      sets: 3, reps: "10-12", rir: 1 },
      { id: "leg_curl",     sets: 3, reps: "10-12", rir: 1 },
      { id: "seated_calf",  sets: 4, reps: "12-15", rir: 0 },
    ],
  },
...
export const GLUCOSE_CONTEXTS = [
  ...
  { id: "post_1h",    label: "After meal (+1h)" },
  { id: "post_2h",    label: "After meal (+2h)" },
